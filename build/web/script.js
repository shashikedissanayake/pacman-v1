...
var response;
var source = new EventSource('gameUpdate');
...
function paint() {
	...
	for (i=0; i< pLength; i++){
		paint_player(players[i][0],players[i][3],players[i][2]);
	...
	for (i=0; i< fLength; i++){
		paint_food(foods[i][0],foods[i][2],foods[i][1]);
	}
...
function sendPlayerPosition(){    
	if(true){
		...
		xmlhttprequest.open("POST","gameUpdate?keypress=" + keypress,true);
		xmlhttprequest.send();
